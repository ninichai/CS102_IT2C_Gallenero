...
CSV
```{r}
write.csv(All50_Prod_Reviews, "All_50Product_Reviews.csv")
...
dbWriteTable(connection, 'lab_exer2_prods', All50_Prod_Reviews, append = TRUE)
```
...
dbListFields(connection,"lab_exer2_prods")
```
...
review_data <- dbGetQuery(connection, "SELECT * FROM gallenero.lab_exer2_prods")
glimpse(review_data)
